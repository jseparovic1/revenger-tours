<nav class="navigation container text-center absolute pin-t z-10 left-50">
    <div class="flex justify-between items-center relative -left-50 py-5">
        ...
        <ul class="flex list-reset">
            ...
            <li class="flex">
                <a href="#" class="px-5 py-5 mx-3 text-white tracking-wide font-bold">PRIVATE TOURS</a>
            </li>
            <li class="flex">
                <a href="#" class="px-5 py-5 mx-3 text-white tracking-wide font-bold">TRANSFERS</a>
            </li>
            <li class="flex">
                <a href="#" class="px-5 py-5 mx-3 text-white tracking-wide font-bold">CONTACT</a>
            </li>
        </ul>
    </div>
</nav>
